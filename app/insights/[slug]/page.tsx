  ...
  return (
    <article className="bg-white pb-12 pt-24 md:pb-16 md:pt-28">
      <Container className="max-w-4xl">
        <Reveal>
          <p className="text-hi-accent">{post.category}</p>
        ...
        <Reveal delay={0.12}>
          <div className="mt-10 space-y-5 text-lg leading-relaxed text-hi-black/90">
            <p>{post.excerpt}</p>
            <p>
              Health Invest Africa continues to expand specialty capacity across Nigeria
              through OncoClinics Africa and Rencare Africa—investing in infrastructure,
